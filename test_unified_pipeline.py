...
def _run_smoke_script():
    """Original smoke script logic moved under a function so pytest won't
    execute it on import. Running this file directly still performs the
    intended quick end-to-end check.
    """
